$(document).ready(function () {
    ...
    switch ($("#hidLang").val()) {
        ...
        case "en":
            // LOGIN
            $("#head_pag1").text("Access to MyPlace");
            $("#desc1_pag1").html("Welcome to this exclusive member area. This is a space where you can continue to enjoy the Holmes Place experience.<br />Your club, anytime, anywhere.");
            $("#username").attr("placeholder", "E-mail");
            $("#password").attr("placeholder", "Password");
            $(".forget-password").text("I forgot my password");
            $("#btnLogin_pag1").text("Access");
            $("#head2_pag1").text("Create your access account");
            $("#desc2_pag1").text("If you are already a Holmes Place member, you can register by clicking on the \"Create my account\" button.");
            $("#btnAlta_pag1").text("Create my account");
            $("#btnContactar_pag1").text("Contact Us");
        ...
        case "ca":
            // LOGIN
            $("#head_pag1").text("Accés a l'Àrea Privada");
            $("#desc1_pag1").html("Benvingut a l'Àrea Privada de socis Holmes Place, un espai des d'on podràs seguir gaudint de l'experiència amb nosaltres.<br />El teu Club, on i quan vulguis.");
            $("#username").attr("placeholder", "Email");
            $("#password").attr("placeholder", "Contrasenya");
            $(".forget-password").text("He oblidat la meva contrasenya");
            $("#btnLogin_pag1").text("Accedir");
            $("#head2_pag1").text("Crea el teu compte d'accés per a l'Àrea Privada");
            $("#desc2_pag1").text("Si ja ets soci de Holmes Place, pots donar-te d'alta al Àrea Privada de socis des del següent enllaç.");
            $("#btnAlta_pag1").text("Crear el meu compte");
            $("#btnContactar_pag1").text("Contacta amb nosaltres");
